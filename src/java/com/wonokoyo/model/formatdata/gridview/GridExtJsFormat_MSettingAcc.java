 ...
 *Contoh bentuk XML nya : <br/>
        ...
        {@code <dataset> }<br/>
            &nbsp;&nbsp;&nbsp;{@code <row> }<br/>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@code <accform></accform> }<br/>
 *            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@code <editfinalapprove></editfinalapprove> }<br/>
            &nbsp;&nbsp;&nbsp;{@code </row> }<br/>
            &nbsp;&nbsp;&nbsp;{@code <row> }<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@code <kodeform></kodeform> }<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@code <namaform></namaform> }<br/>
 ...
 *
 */
public class GridExtJsFormat_MSettingAcc {
     ...
     * {@code <accform> }
     */
    public static final String accformElAwal = "<accform>";

    /**
     * berisi elemen: {@code </accform>}
     */
    public static final String accformElAkhir = "</accform>";

    /**
     * berisi elemen : <br/>
     * {@code <editfinalapprove> }
     */
    public static final String editfinalapproveElAwal = "<editfinalapprove>";

    /**
     * berisi elemen: {@code </editfinalapprove>}
     */
    public static final String editfinalapproveElAkhir = "</editfinalapprove>";
