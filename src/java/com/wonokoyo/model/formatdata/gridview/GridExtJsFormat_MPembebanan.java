 ...
 *Contoh bentuk XML nya : <br/>
        ...
        {@code <dataset> }<br/>
            &nbsp;&nbsp;&nbsp;{@code <row> }<br/>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@code <namapembebanan></namapembebanan> }<br/>
            &nbsp;&nbsp;&nbsp;{@code </row> }<br/>
            &nbsp;&nbsp;&nbsp;{@code <row> }<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@code <kodepembebanan></kodepembebanan> }<br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@code <namapembebanan></namapembebanan> }<br/>
 ...
 *
 */
public class GridExtJsFormat_MPembebanan {
     ...
     * {@code <namapembebanan> }
     */
    public static final String namapembebananElAwal = "<namapembebanan>";

    /**
     * berisi elemen: {@code </namapembebanan>}
     */
    public static final String namapembebananElAkhir = "</namapembebanan>";
}
