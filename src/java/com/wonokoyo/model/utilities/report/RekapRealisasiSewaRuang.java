 ...
 * @author Indra
 */
public class RekapRealisasiSewaRuang extends HttpServlet {
            ...
            
    {
        try{
            ...
            try {
                    ...
                    System.out.println(request.getParameter("awal"));
                    System.out.println(request.getParameter("akhir"));
                    System.out.println(request.getParameter("namabp"));
