...
function browseHPengajuan(Store,formMode,awal,akhir,sqlString)
{
     var columnsheader= [{header: "Kode Pengajuan", dataIndex: 'kodepengajuan'},
          {header: "Tanggal", dataIndex: 'tanggal', xtype: 'datecolumn',format: 'd M Y'},
          ...
          {header: "Versi", dataIndex: 'versi', xtype: 'numbercolumn',format: '0',align:'right',width:50}
          //{header: "Total Biaya", dataIndex: 'totalbiaya', renderer: Ext.util.Format.CurrencyFactory(2,',','.','Rp',true),align:'right'}
   ...
   //search[0].cloneConfig({colspan:2})
