 ...
 */
function getForm_lrekapreservasi(pformid,ptitle,formMode,pview,padd,pupdate,pdelete,pprint){
    var namabp;var namaitem;var c=1;var d=1;
    var akhir;
    var awal; 
   ...
   tglStore.load();
    ...
    var storePemohon=get_t_pengajuanStore("READ",SqlCustom_t_pengajuan.get_CmbPemohon(),false);    
    ...
    var storeItem=get_sd_itempengajuanStore("READ",SqlCustom_sd_itempengajuan.get_selectCmb(),false);
    ...
    rb_PemohonCustom.on('check',function(a,b){
        if(b==true)
           ...
           {cmb_pemohon.disable();d=1;namabp='%%';}
    });
    ...
    btnPriview.on('click', function() {
        ...
        if (d==1)
            ...
            {
             namabp=cmb_pemohon.getValue();
             
            }
              var a = new  RequestReport ('maincontroller','Reservasi');
              a.params.awal = awal;      
